...
try:
    ...
    from src.magic_pdf.model.pek_sub_modules.layoutlmv3.model_init import Layoutlmv3_Predictor
    from src.magic_pdf.model.pek_sub_modules.post_process import get_croped_image, latex_rm_whitespace
    from src.magic_pdf.model.pek_sub_modules.self_modify import ModifiedPaddleOCR
except ImportError:
