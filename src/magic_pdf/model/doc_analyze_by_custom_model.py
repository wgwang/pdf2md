...
from src.magic_pdf.libs.config_reader import get_local_models_dir, get_device
from src.magic_pdf.model.model_list import MODEL
...
def custom_model_init(ocr: bool = False, show_log: bool = False):
    ...
    if model_config.__use_inside_model__:
        ...
        if model == MODEL.Paddle:
            from src.magic_pdf.model.pp_structure_v2 import CustomPaddleModel
            custom_model = CustomPaddleModel(ocr=ocr, show_log=show_log)
        elif model == MODEL.PEK:
            from src.magic_pdf.model.pdf_extract_kit import CustomPEKModel
