from src.magic_pdf.libs.boxbase import _is_in, _is_in_or_part_overlap, calculate_overlap_area_2_minbox_area_ratio
from loguru import logger

from src.magic_pdf.libs.drop_tag import COLOR_BG_HEADER_TXT_BLOCK
